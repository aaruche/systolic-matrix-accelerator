...
class alignas(VL_CACHE_LINE_BYTES)VPE_tb__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_PE_tb__a_forwarding_hold;
    VerilatedScope __Vscope_PE_tb__a_forwarding_outputs;
    VerilatedScope __Vscope_PE_tb__a_invalid_product_holds_accumulator;
