...
VL_INLINE_OPT void VPE_tb___024root___nba_sequent__TOP__0(VPE_tb___024root* vlSelf) {
    ...
    if (vlSymsp->_vm_contextp__->assertOnGet(1, 1)) {
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
                                  | (vlSelfRef.__Vsampled_TOP__PE_tb__DOT__dut__DOT__accum_reg 
                                     == vlSelfRef.PE_tb__DOT__dut__DOT__accum_reg)))))) {
            VL_WRITEF_NX("[%0t] %%Error: PE_sva.sv:153: Assertion failed in %NPE_tb.a_accumulator_output: C does not match the accumulator register\n",0,
                         64,VL_TIME_UNITED_Q(1000),
                         -9,vlSymsp->name());
            VL_STOP_MT("tb/PE_sva.sv", 153, "");
        }
    }
    if (vlSymsp->_vm_contextp__->assertOnGet(1, 1)) {
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
                                  | ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT___Vpast_13_0)) 
                                     | (vlSelfRef.__Vsampled_TOP__PE_tb__DOT___Vpast_14_0 
                                        == vlSelfRef.PE_tb__DOT__dut__DOT__accum_reg))))))) {
            VL_WRITEF_NX("[%0t] %%Error: PE_sva.sv:114: Assertion failed in %NPE_tb.a_invalid_product_holds_accumulator: Accumulator changed without a valid product\n",0,
                         64,VL_TIME_UNITED_Q(1000),
                         -9,vlSymsp->name());
            VL_STOP_MT("tb/PE_sva.sv", 114, "");
        }
    }
    if (vlSymsp->_vm_contextp__->assertOnGet(1, 1)) {
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
    ...
    if (vlSymsp->_vm_contextp__->assertOnGet(1, 1)) {
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
                                  | (((IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__dut__DOT__A_forw_reg) 
                                      == (IData)(vlSelfRef.PE_tb__DOT__dut__DOT__A_forw_reg)) 
                                     & ((IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__dut__DOT__B_forw_reg) 
                                        == (IData)(vlSelfRef.PE_tb__DOT__dut__DOT__B_forw_reg)))))))) {
            VL_WRITEF_NX("[%0t] %%Error: PE_sva.sv:142: Assertion failed in %NPE_tb.a_forwarding_outputs: Forwarding outputs do not match their registers\n",0,
                         64,VL_TIME_UNITED_Q(1000),
                         -9,vlSymsp->name());
            VL_STOP_MT("tb/PE_sva.sv", 142, "");
        }
    }
    if (vlSymsp->_vm_contextp__->assertOnGet(1, 1)) {
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
        ...
        if (VL_UNLIKELY((1U & (~ ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT__rst_n)) 
                                  | ((~ (IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT___Vpast_15_0)) 
                                     | (((IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT___Vpast_16_0) 
                                         == (IData)(vlSelfRef.PE_tb__DOT__dut__DOT__A_forw_reg)) 
                                        & ((IData)(vlSelfRef.__Vsampled_TOP__PE_tb__DOT___Vpast_17_0) 
                                           == (IData)(vlSelfRef.PE_tb__DOT__dut__DOT__B_forw_reg))))))))) {
            VL_WRITEF_NX("[%0t] %%Error: PE_sva.sv:129: Assertion failed in %NPE_tb.a_forwarding_hold: Forwarding registers changed while forwarding was disabled\n",0,
                         64,VL_TIME_UNITED_Q(1000),
                         -9,vlSymsp->name());
    ...
    vlSelfRef.PE_tb__DOT___Vpast_14_0 = vlSelfRef.PE_tb__DOT__dut__DOT__accum_reg;
